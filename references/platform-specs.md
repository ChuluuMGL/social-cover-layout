...
Last checked: 2026-07-15. This matrix separates published technical constraints, the platform surface being designed for, and the practical layout default used by this Skill.
...
| YouTube | Shorts frame | 9:16 | video frame, no custom-thumbnail claim | verified-official | center-safe title; do not promise an uploadable custom thumbnail |
| Bilibili | video cover | 16:9 | 1280×720 working canvas | surface-dependent | keep bottom metadata band quiet; keep top-right safe |
| WeChat | article cover | about 21:9 | 900×383 working canvas | working-default | wide editorial band; never stretch XHS |
| WeChat | share card | 1:1 | 900×900 working canvas | working-default | square proof card; title and subject centered in the safe area |
...
| LinkedIn | single-image ad | 1.91:1, 1:1, or 4:5 | 1200×628, 1200×1200, or 720×900 | verified-official | choose ad placement before composing; vertical is mobile-oriented |
...
- **YouTube Shorts:** YouTube says Shorts do not support uploading a custom thumbnail like long-form videos; the Skill therefore outputs a 9:16 candidate frame and labels it as a frame, not a guaranteed custom-thumbnail upload.
...
- For RTL scripts, reserve the reading-safe side after text shaping; do not mirror a finished LTR composition.
