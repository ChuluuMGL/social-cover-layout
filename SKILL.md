---
name: content-cover-router
description: "把 content-creation 生成的笔记 brief 路由成平台封面。根据内容目的、媒体比例、视觉主体和用户是否提供人像，选择原创的高对比大字、产品证据、人物出镜、字体主视觉或编辑感路线，并输出可生成、可质检的封面。"
---
...
```text
使用 $content-cover-router，把这篇小红书笔记做成封面
```
